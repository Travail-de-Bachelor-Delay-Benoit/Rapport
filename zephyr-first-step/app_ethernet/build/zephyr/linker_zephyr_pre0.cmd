...
MEMORY
    ...
    RAM (wx) : ORIGIN = 0x20020000, LENGTH = (384 * 1K)
    QSPI_PLACEHOLDER ( rw ) : ORIGIN = (2415919104), LENGTH = (268435456) SRAM0 ( rw ) : ORIGIN = (537001984), LENGTH = (393216) DTCM ( rw ) : ORIGIN = (536870912), LENGTH = (131072) SDRAM1 ( rw ) : ORIGIN = (3221225472), LENGTH = (16777216) QSPI_AVAIL ( rw ) : ORIGIN = (2415919104), LENGTH = (67108864)
...
noinit (NOLOAD) :
{
    ...
    __kernel_ram_end = 0x20020000 + (384 * 1K);
